    ...
    <div className="min-h-screen bg-[#FFF9FB] text-slate-900 font-sans selection:bg-pink-200 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-6 pt-12 text-center">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl px-4">
            <NavLink to="/barcode" className="group">
              <div className="h-full p-10 bg-white/60 backdrop-blur-xl rounded-[3rem] border border-white shadow-[0_20px_50px_rgba(255,182,193,0.2)] transition-all duration-500 hover:shadow-[0_30px_60px_rgba(255,182,193,0.4)] hover:-translate-y-3">
                <div className="w-16 h-16 bg-gradient-to-br from-pink-400 to-rose-400 text-white rounded-3xl flex items-center justify-center mb-8 shadow-lg shadow-pink-200 group-hover:rotate-12 transition-transform">
                  <ScanLine size={32} />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 mb-3 text-left tracking-tight">Scan Barcode</h3>
            ...
            <NavLink to="/scan" className="group">
              <div className="h-full p-10 bg-white/60 backdrop-blur-xl rounded-[3rem] border border-white shadow-[0_20px_50px_rgba(192,132,252,0.15)] transition-all duration-500 hover:shadow-[0_30px_60px_rgba(192,132,252,0.3)] hover:-translate-y-3">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-400 to-pink-400 text-white rounded-3xl flex items-center justify-center mb-8 shadow-lg shadow-purple-100 group-hover:-rotate-12 transition-transform">
                  <Camera size={32} />
                </div>
                <h3 className="text-2xl font-bold text-slate-800 mb-3 text-left tracking-tight">Analyze Photo</h3>
            ...
            <NavLink to="/products" className="group">
              <div className="h-full p-10 bg-slate-900 rounded-[3rem] shadow-2xl transition-all duration-500 hover:-translate-y-3 hover:bg-slate-800">
                <div className="w-16 h-16 bg-white/10 text-white rounded-3xl flex items-center justify-center mb-8 backdrop-blur-lg border border-white/20 group-hover:scale-110 transition-transform">
                  <Sparkles size={32} className="text-pink-300" />
                </div>
                <h3 className="text-2xl font-bold text-white mb-3 text-left tracking-tight">Catalog</h3>
