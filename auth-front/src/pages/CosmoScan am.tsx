...
export default function CosmoScan() {
  ...
  const calculateScore = async () => {
    ...
    try {
      ...
      saveToHistory({ type: "photo", productName: "Produit Scanné", ingredients: ingredients.join(", ") });
  ...
  function handleFavorite() {
    if (liked) {
      ...
      saveFavorite({ type: "photo", productName: "Produit Scanné", ingredients: ingredients.join(", ") });
      setLiked(true);
    }
  }
